...
class Dialog1(arcade.gui.UIBoxLayout):
...
class Vibor(arcade.gui.UIBoxLayout):
    def __init__(self):
        ...
        self.vibor1_button = arcade.gui.UIFlatButton(text="Уехать домой, так как становиться небезопасно", width=500, height=150, style=red_style)
        self.vibor2_button = arcade.gui.UIFlatButton(text="Остаться и найти сумасшедшего деда, чтобы выяснить подробности", width=500, height=150, style=red_style)
